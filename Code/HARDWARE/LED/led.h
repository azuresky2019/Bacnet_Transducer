...
#define HB	PEout(6)// DS1
#define LED0	PEout(0)// DS1
#define LED1	PEout(1)// DS1
#define LED2	PEout(2)// DS1
#define LED3	PEout(3)// DS1
#define LED4	PEout(4)// DS1
#define LED5	PEout(5)// DS1

#define PIN_TEST	PAout(14)// DS1
